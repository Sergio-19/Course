...
renderInputs = () =>{
  ...
  dataWrite = async () =>{
   ...
   await axios.post('https://course-918e5.firebaseio.com/sample.json', this.state.sample)
   .then((response)=>{
     return('')
   ...
   await axios('https://course-918e5.firebaseio.com/sample.json')
  ...
  sampleRemove =  async (id) =>{
    ...
    await axios.delete(`https://course-918e5.firebaseio.com/sample/${id}.json`)
